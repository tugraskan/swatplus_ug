!--------------------------------------------------------------------
!  actions
!    Execute all management activities scheduled for the current
!    object.  Operations include tillage, fertilizer applications,
!    planting and harvesting.  The routine also routes associated
!    constituent loads generated by these actions.
!--------------------------------------------------------------------
