      ...
      type fertilizer_db
        ...
        real :: fminn = 0.            !! kg minN/kg frt     |fract of fert which is mineral nit (NO3+NH3) |range: 0..1
        real :: fminp = 0.            !! kg minN/kg frt     |frac of fert which is mineral phos |range: 0..1
        real :: forgn = 0.            !! kg orgN/kg frt     |frac of fert which is org n |range: 0..1
        real :: forgp = 0.            !! kg orgP/kg frt     |frac of fert which is org p |range: 0..1
        real :: fnh3n = 0.            !! kg NH3-N/kg N      |frac of mineral N content of fert which is NH3 |range: 0..1
